          ...
          >
            <div class="video_container">
              ...
              <video
                ...
                src="http://vd2.bdstatic.com/mda-na20t1tubcczrgxe/cae_h264/1641173570275515238/mda-na20t1tubcczrgxe.mp4?v_from_s=hkapp-haokan-hb"
              ...
              <img
                ...
                class="play"
                @click="playvideo"
                src="http://oss.jishiyoo.com/images/file-1575343195934.jpg"
              />
              <!-- 播放暂停按钮 -->
              <img
                v-show="iconPlayShow"
            ...
            <div class="tools_right">
              ...
              <div class="tools_r_li" @click="changeComment">
                <i
                  class="iconfont icon-liuyan icon_right icon_right_change"
                ></i>
            ...
            <div class="production_box">
              <div class="production_name">@{{ item.type }}</div>
...
export default {
  ...
  created(){
        ...
        axios.get("http://106.14.145.57:7788/api/v1/video").then(e=>{
            console.log("我是网络",e)
            this.videoList.push(e.data.data)
        })
